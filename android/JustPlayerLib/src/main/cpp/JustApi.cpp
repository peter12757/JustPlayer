...
#include <jni.h>
#include <string>
#include "justplayer/player/JustPlayer.h"
#include "LogUtil.h"
#include "util/JniHelper.h"
#include "JustData.h"
#include "cpptest/InvokeMain.h"
...
Java_com_eathemeat_player_JustApi_createPlayer(
    ...
    JustPlayer* player = new JustPlayer();
...
Java_com_eathemeat_player_JustApi_invoke(JNIEnv *env, jobject thiz,jlong handle,jbyteArray data) {
    ...
    JustData::Package::Unpack up(strData.data(), strData.size());
