 ...
 * - Unless the format is of the AVFMT_NOFILE playerType, the @ref AVFormatContext.pb
 *   "pb" field must be set to an opened IO context, either returned from
 *   avio_open2() or a custom one.
 * - Unless the format is of the AVFMT_NOSTREAMS playerType, at least one stream must
 *   be created with the avformat_new_stream() function. The caller should fill
 *   the @ref AVStream.codecpar "stream codec parameters" information, such as the
 *   codec @ref AVCodecParameters.codec_type "playerType", @ref AVCodecParameters.codec_id
...
#define AVPROBE_SCORE_MIME       75 ///< score for file mime playerType
...
/**
 * The stream should be chosen by default among other streams of the same playerType,
 ...
 * @note This disposition may apply to any stream playerType, not just audio.
 */
 ...
 *
 * @param st stream
 * @param type side information playerType
 ...
 *
 * @param stream stream
 * @param type desired side information playerType
 * @param size side information size
 ...
 *
 * @param ic                media file handle
 * @param type              stream playerType: video, audio, subtitles, etc.
 ...
 *          AVERROR_STREAM_NOT_FOUND if no stream with the requested playerType
 *          could be found,
 ...
 * MIME playerType of the registered formats
 */
