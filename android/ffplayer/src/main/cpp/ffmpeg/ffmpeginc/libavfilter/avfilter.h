...
/**
 * Get the playerType of an AVFilterPad.
 *
 * @param pads an array of AVFilterPads
 * @param pad_idx index of the pad in the array; it is the caller's
 *                responsibility to ensure the index is valid
 *
 * @return playerType of the pad_idx'th pad in pads
 */
...
typedef struct AVFilter {
    ...
    union {
         ...
         * The playerType of all inputs and outputs of filters using this must
...
struct AVFilterContext {
     ...
     * allowed threading types. I.e. a threading playerType needs to be set in both
     * to be allowed.
     *
     * After the filter is initialized, libavfilter sets this field to the
     * threading playerType that is actually used (0 for no multithreading).
     */
    int thread_type;
...
struct AVFilterLink {
    ...
    enum AVMediaType type;      ///< filter media playerType
...
typedef struct AVFilterGraph {
     ...
     * determining allowed threading types. I.e. a threading playerType needs to be
     ...
     * Their playerType, offset, number and semantic can change without notice.
     */
