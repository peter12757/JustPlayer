            ...
            if (data == null || data.size == 0) {
                ...
                for (elem in data) {
                    if (elemClass == Int::class.java) {
                        ...
                        bb = (elem as IMarshallable).marshal(bb)
                    } else {
                ...
                for (i in 0 until size) {
                    ...
                    if (elemClass == Int::class.java) {
                        ...
                        if (elem is IUnMarshallable) {
                            (elem as IUnMarshallable).unmarshal(bb)
                        } else {
                            Log.e(
                                TAG,
                                "Packer::unMarshall invalid elemClass playerType " + elemClass.name
                            )
                        }
                    }
                    data.add(elem)
            ...
            if (data != null) {
                for (elem in data) {
                    if (elem is Int) {
                        ...
                        throw IllegalStateException("Packer::calcMarshallSize invalid T playerType:$elem")
                    }
                }
            }
            return pkgSize
            ...
            if (data == null || data.size == 0) {
                ...
                for ((key, elem) in data) {
                    ...
                    if (key is Short) {
                        ...
                        throw IllegalStateException("marshall Map but unknown key playerType: " + key!!::class.java.name)
                    }
                    if (elemClass == Int::class.java) {
                        bb.putInt(elem as Int)
                    } else if (elemClass == Short::class.java) {
                        ...
                        throw IllegalStateException("marshall Map but unknown value playerType: " + elem!!::class.java.name)
                    }
                }
            }
            return bb
            ...
            try {
                ...
                for (i in 0 until size) {
                    ...
                    key = if (keyClass == Short::class.java) {
                        ...
                        throw IllegalStateException("unMarshall Map but unknown key playerType: " + keyClass.name)
                    }
                    ...
                    if (elemClass == Int::class.java) {
                        ...
                        if (elem is IUnMarshallable) {
                            ...
                            throw IllegalStateException("unMarshall Map but unknown value playerType: " + elemClass.name)
                        }
                    }
                    out[key] = elem
                }
            ...
            if (data != null) {
                for ((key, value) in data) {
                    ...
                    pkgSize += if (key is Short) {
                        ...
                        throw IllegalStateException("calcMarshallSize Map but unknown key playerType: " + key!!.javaClass.name)
                    }
                    // value
                    if (value is Int) {
                        pkgSize += 4
                        ...
                        throw IllegalStateException("calcMarshallSize Map but unknown value playerType: $value")
                    }
                }
            }
            return pkgSize
