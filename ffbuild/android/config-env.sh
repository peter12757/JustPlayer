...
## Unknown option "--disable-ffserver". ffmpeg 3.4以后的版本不在支持ffserver
...
## Unknown option "--disable-avresample".
...
#loongson 龙芯，在移动端下disable，PC上可以开下
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-mmi"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-lsx"
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-lasx"
